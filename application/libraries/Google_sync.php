...
class Google_sync
{
    ...
    public function initialize_clients(): void
    {
        ...
        $this->client->setApplicationName('Div4ataZaKermom');
     ...
     * where the user grants access to his data for the Div4ataZaKermom app.
     */
     ...
     * provider granted consent to Div4ataZaKermom for use his Google Calendar account.
     *
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of Div4ataZaKermom
