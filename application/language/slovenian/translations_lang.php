...
$lang['about_app_info'] = 'Div4ataZaKermom je zelo prilagodljiva spletna aplikacija, ki vašim strankam omogoča, da rezervirajo sestanke pri vas prek spleta. Poleg tega ponuja možnost sinhronizacije vaših podatkov z Google Koledarjem, tako da jih lahko uporabljate z drugimi storitvami.';
$lang['current_version'] = 'Trenutna različica';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Če naletite na težave pri uporabi Div4ataZaKermom, lahko poiščete odgovore v uradni Googlovi skupini. Morda boste morali ustvariti tudi novo številko na strani Google Code, da bi pomagali pri napredovanju razvoja.';
...
$lang['about_app_license'] = 'Div4ataZaKermom je licenciran pod licenco GPLv3. Z uporabo kode Div4ataZaKermom na kakršen koli način soglašate s pogoji, opisanimi na naslednjem url-ju:';
...
$lang['ea_update_success'] = 'Div4ataZaKermom je bil uspešno posodobljen.';
...
$lang['api_token_hint'] = 'Nastavite skrivni žeton, da omogočite avtentikacijo Div4ataZaKermom API na podlagi žetonov.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vam omogoča interakcijo z vsemi podatki Div4ataZaKermom prek protokola HTTP in razpoložljivih končnih točk API ter ustvarjanje lastnih integracij.';
...
$lang['connect'] = 'Poveži';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ta integracija vam omogoča, da se povežete z obstoječim strežnikom LDAP in samodejno uvozite uporabnike v Div4ataZaKermom ter jim omogočite SSO z njihovim geslom imenika (uporabniško ime se mora ujemati).';
$lang['host'] = 'Gostitelj';
$lang['port'] = 'Vrata';
