...
$lang['about_app_info'] = 'Div4ataZaKermom jest aplikacją webową wysoce przystosowywalną do potrzeb klienta. Co więcej pozwala na synchronizację z Kalendarzem Google.';
...
$lang['about_app_license'] = 'Div4ataZaKermom posiada licencję GPLv3. Używaj zgodnie z warunkami opisanymi tu:';
...
$lang['api_token_hint'] = 'Ustaw tajny token, aby włączyć uwierzytelnianie oparte na tokenie w API Div4ataZaKermom.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API umożliwia interakcję ze wszystkimi danymi Div4ataZaKermom za pomocą protokołu HTTP oraz dostępnych punktów końcowych API i tworzenie własnych integracji.';
...
$lang['connect'] = 'Połącz';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ta integracja umożliwia połączenie z istniejącym serwerem LDAP i automatyczne importowanie użytkowników do Div4ataZaKermom oraz umożliwienie im logowania się za pomocą hasła z katalogu (nazwa użytkownika musi się zgadzać).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
