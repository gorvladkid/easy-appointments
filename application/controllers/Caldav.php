    ...
    public static function sync(string $provider_id): void
    {
        ...
        foreach ($local_events as $local_event) {
            ...
            try {
                ...
                // If CalDAV Calendar event is different from Div4ataZaKermom appointment then update Div4ataZaKermom record.
                ...
                // Appointment not found on CalDAV Calendar, delete from Div4ataZaKermom.
        ...
        // Add CalDAV Calendar events that do not exist in Div4ataZaKermom.
