...
class Google extends EA_Controller
{
    ...
    /**
     * Complete synchronization of appointments between Google Calendar and Div4ataZaKermom.
     *
    ...
    public static function sync(?string $provider_id = null): void
    {
        try {
            ...
            foreach ($local_events as $local_event) {
                ...
                try {
                    ...
                    if ($google_event->getStatus() == 'cancelled') {
                        throw new Exception('Event is cancelled, remove the record from Div4ataZaKermom.');
                    }

                    // If Google Calendar event is different from Div4ataZaKermom appointment then update Div4ataZaKermom record.
                    ...
                    // Appointment not found on Google Calendar, delete from Div4ataZaKermom.
            ...
            // Add Google Calendar events that do not exist in Div4ataZaKermom.
            ...
            foreach ($google_events->getItems() as $google_event) {
                ...
                // Record doesn't exist in the Div4ataZaKermom, so add the event now.
                $local_event = [
     ...
     * documentation of OAuth), every Div4ataZaKermom installation should use its own calendar api key. So in every
     * api console account, the "http://path-to-Div4ataZaKermom/google/oauth_callback" should be included in an
