...
Run the development containers of Div4ataZaKermom with Docker and Docker Compose utility. Docker allows you to compose your application in microservices, so that you can easily get started with the local development.
...
A production image of Div4ataZaKermom can be found at: https://github.com/alextselegidis/easyappointments-docker
