...
This page will guide you through the update procedure of your Div4ataZaKermom installation. You will need to follow the steps below in order to have successful results.
...
###### Step 1: Update your Div4ataZaKermom files
...
Open your browser to the Div4ataZaKermom installation URL, login to the backend and type in the browser address the following URL to complete the database upgrade: `https://url/to/easyappointments/folder/index.php/backend/update`
