...
- #664: Div4ataZaKermom v1.3.2 allows sensitive information disclosure (username and password hash).
...
- #176: Add Docker container for Div4ataZaKermom development.
...
- #21: Fix Div4ataZaKermom installation problems with AJAX requests.
- #66: Trouble with breaks for providers.

## [1.0.0] - 2014-01-19 

First Div4ataZaKermom release ever! ☺
