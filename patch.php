...
/* ----------------------------------------------------------------------------
 * Div4ataZaKermom - Patch Utility Script
 *
...
function detect_local_version()
{
    ...
    if (!file_exists($config_file_path)) {
        die(
            'Failed to detect the local Div4ataZaKermom version, please move the patch.php script in the root directory of your Div4ataZaKermom installation.'
        );
    }
...
echo LINE_BREAK . '➜ Div4ataZaKermom - Patch Utility Script' . LINE_BREAK . LINE_BREAK;
